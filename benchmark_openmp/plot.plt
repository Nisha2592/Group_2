...
# Titles and labels
set title "Benchmark Comparison: Non-Optimized vs Optimized vs Optimized-openMP"
set xlabel "natom"
set ylabel "Time (s)"
...
plot "benchmark_data.dat" using 1:2 with linespoints title "Non-Optimized" lc rgb "red" lw 2 pt 7, \
     ...
     "benchmark_data.dat" using 1:4 with linespoints title "Optimized-openMP (8 threads)" lc rgb "green" lw 2 pt 8
